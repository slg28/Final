...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            id='drop-down-statistics',
            options='Yearly Statistics',
            value='Yearly Statistics',
            placeholder='Select a report type',
            style={'width': '8%', 'padding':3, 'font-size':20, 'text-align-last': "center"}
            )
    ]),
    ...
    html.Div(id='potput-container', className='chart-grid', style={}'display': 'flex'}),])
])
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Avrage Automobile Sales by Vehicle Type"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
                ...
                names='Vehicle_Type',
                title="Advertising Expenditures by Vehicle Type during Recession"
                )
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        R_chart4 = dcc.Graph(figure=px.bar(ur,
        x='unemployment_rate',
        y='Automobile_Sales',
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditure'].mran().reset_index()
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', children=[html.Div(children=Y_chart3), htlm.Div(children=Y_chart4)],style={'display': 'flex'})
