...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistical Dashboard"),style={'textAlign': 'center', 'color': '#503D36', 'font-size':24 })
...
@app.callback(
    ...
    Input(component_id='dropdown-statistics',component_property='valu'))
...
def update_output_container(yearly_statistics, recession_period_statistics):
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby('unemployment_rate', 'Vehicle_Type')['Automonile_Sales'].mean().reset_index()
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditures'].mean().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
            values='Advertising_Expenditures',
            names='Vehicle_Type',
            title='Total Advertising Expenditure zfor Each Vehicle Type'))
